    ...
    useEffect(() => {
      ...
      const run = async () => {
        try {
          ...
          const mt = (mostRes.data && mostRes.data.length > 0 ? mostRes.data[0] : null) as
            | MostTrainedViewRow
            | null;
      ...
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white text-neutral-900 relative">
        ...
        <main className="max-w-7xl mx-auto px-6 py-10">
          ...
          <section className="mb-10">
            ...
            <p className="text-neutral-600">Here’s an overview of your recent training and progress.</p>
          </section>
